...
data = {
    ...
    'Latitude': [37.7749, 39.9042, 35.6762, 51.1657, 51.509865, 20.5937, 46.2276, -14.2350, 43.1719, 43.6532, 36.3301, 61.5240, -33.8651, 40.4637, -6.1745, 19.4326, 38.9637, 46.9480, 59.3343, 51.9194, 52.3702, 59.9139, 50.8503, 13.7465, 24.7136, 31.7833, 53.3478, 55.6761, 1.3521, 22.3964, 22.3964],  # Added one more element
    'Longitude': [-122.4194, 116.4074, 139.6503, 10.4515, -0.118092, 77.1025, 2.2137, -51.9253, 12.5050, -79.3832, 127.9944, 105.3188, 151.2059, -3.7492, 106.8650, -99.1332, 35.2433, 7.4474, 18.0706, 19.1451, 4.8952, 10.7564, 5.4200, 100.5068, 46.6753, 35.2057, -6.2603, 12.5683, 103.8565, 114.1734, 114.1734],  # Added one more element
    'Value': [None] * 31  # Initialize with the same length as 'Country'  # Placeholder for index values
}
